...
format:
  html:
    ...
    df-print: paged
    output-file: "Preliminary_Results.html"
---

```{css, echo=FALSE}
/* This makes the title blue as you requested earlier */
h1.title {
  color: steelblue;
}
...
**Experimental Design:** The experiment consists of six open-air arrays (referred to as **"Rings"**), each 25 meters in diameter and rising into the canopy. \* **Treatment (**$eCO_2$): 3 Rings release $CO_2$ programmed to maintain concentrations 150 ppm above ambient levels. \* **Control (**$aCO_2$): 3 Rings release ambient air to control for infrastructure effects.
